...
for input_line in input:
    ...
    if line[0][0] == line[1][0]:
        ...
        dir_x = -1 if line[0][0] > line[1][0] else 1
        dir_y = -1 if line[0][1] > line[1][1] else 1
        steps = max(line[0][1], line[1][1]) - min(line[0][1], line[1][1])

        x = line[0][0]
        for y in range(line[0][1], line[1][1] + dir_y, dir_y):
            increment_pos((x, y))
            x += dir_x
